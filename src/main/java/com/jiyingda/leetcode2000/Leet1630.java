...
public class Leet1630 {
    ...
    public static void main(String[] args) {
        PrintUtils.printArray(checkArithmeticSubarrays(new int[]{-12,-9,-3,-12,-6,15,20,-25,-20,-15,-10}, new int[]{0,1,6,4,8,7}, new int[]{4,4,9,7,9,10}));
    ...
    private static boolean checkArithmeticSubarrays(int[] nums, int left, int right) {
        if (right - left < 2) {
            return true;
        }
